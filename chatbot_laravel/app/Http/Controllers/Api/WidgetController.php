...
class WidgetController extends Controller
{
    public function startConversation(Request $request)
    {
        ...
        $agentsOnline = User::anyAvailable($widget->tenant_id);
...
<<<<<<< HEAD
        ...
        try {
            ...
            // 'user_agent' column shayad migration na chalne ki wajah se
            // maujood nahi — usi ke bina conversation create karo taaki
            // chat kabhi break na ho (Visitor Info panel me Device/Browser
            // bas tab tak khali dikhega jab tak migration chala di jaye).
            \Illuminate\Support\Facades\Log::error('Conversation::create failed, retrying without user_agent: ' . $e->getMessage());
...
<<<<<<< HEAD
        ...
        $autoReplyPayload = null;
        try {
            $rule = \App\Models\AutoReply::findMatch($conversation->tenant_id, (string) $request->message);
            if ($rule) {
                ...
                broadcast(new \App\Events\MessageSent($botMessage->load('conversation')));
            ...
            \Illuminate\Support\Facades\Log::error('Auto-reply trigger failed: ' . $e->getMessage());
        }
...
>>>>>>> origin/main
        ...
        $agentsOnline = User::anyAvailable($conversation->tenant_id);
